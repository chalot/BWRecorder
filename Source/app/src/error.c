 ...
 * ´íÎóÃèÊö
 */
static const struct ERRDESP ErrString[] = { { ERR_COMMAND_NOT_SUPPORT,
		"command not supported" }, { ERR_PARAM_INVALID, "param invalid" }, {
...
/*SD¿¨´æÈ¡*/
{ ERR_SDCARD_NOTEXISTED, "SDcard does not existed." }, { ERR_SDCARD_INIT,
		"SDcard init failed." }, { ERR_SD_READ, "SD card can not read" }, {
		ERR_SD_WRITE, "SD card can not write to" }, { ERR_SD_FILENOTEXISTED,
		"the file you read does not existed" }, { ERR_SD_FILECREATEFAILED,
